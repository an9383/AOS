...
namespace HACCP.@__개발Ref_정리됨_._01_매뉴얼._03_컴포넌트매뉴얼.CrystalReport.CrystalReport2016.SAP_Crystal_Reports_sample_reports.Feature_Samples {
    ...
    public class XML_Exporting : ReportClass {
        
        public XML_Exporting() {
        }
        
        public override string ResourceName {
            get {
                return "XML Exporting.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "HACCP.__개발Ref(정리됨).01 매뉴얼.03 컴포넌트매뉴얼.CrystalReport.CrystalReport2016.SAP-Crystal-" +
                    "Reports-sample-reports.Feature Samples.XML Exporting.rpt";
            }
            set {
                // Do nothing
            }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        public CrystalDecisions.Shared.IParameterField Parameter_City___City {
            get {
    ...
    public class CachedXML_Exporting : Component, ICachedReport {
        
        public CachedXML_Exporting() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            XML_Exporting rpt = new XML_Exporting();
            rpt.Site = this.Site;
            return rpt;
        }
