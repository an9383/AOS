...
namespace HACCP.@__개발Ref_정리됨_._01_매뉴얼._03_컴포넌트매뉴얼.CrystalReport.CrystalReport2016.SAP_Crystal_Reports_sample_reports.Financial {
    ...
    public class Trial_Balance : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "HACCP.__개발Ref(정리됨).01 매뉴얼.03 컴포넌트매뉴얼.CrystalReport.CrystalReport2016.SAP-Crystal-" +
                    "Reports-sample-reports.Financial.Trial Balance.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedTrial_Balance : Component, ICachedReport {
        
        public CachedTrial_Balance() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Trial_Balance rpt = new Trial_Balance();
            rpt.Site = this.Site;
            return rpt;
        }
