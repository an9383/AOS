...
namespace HACCP.@__개발Ref_정리됨_._01_매뉴얼._03_컴포넌트매뉴얼.CrystalReport.CrystalReport2016.SAP_Crystal_Reports_sample_reports.Versatile_and_Precise {
    ...
    public class Fortify_Financial_All_in_One_Retirement_Savings : ReportClass {
        
        public Fortify_Financial_All_in_One_Retirement_Savings() {
        }
        
        public override string ResourceName {
            get {
                return "Fortify Financial All-in-One Retirement Savings.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "HACCP.__개발Ref(정리됨).01 매뉴얼.03 컴포넌트매뉴얼.CrystalReport.CrystalReport2016.SAP-Crystal-" +
                    "Reports-sample-reports.Versatile and Precise.Fortify Financial All-in-One Retire" +
                    "ment Savings.rpt";
            }
            set {
                // Do nothing
    ...
    public class CachedFortify_Financial_All_in_One_Retirement_Savings : Component, ICachedReport {
        
        public CachedFortify_Financial_All_in_One_Retirement_Savings() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Fortify_Financial_All_in_One_Retirement_Savings rpt = new Fortify_Financial_All_in_One_Retirement_Savings();
            rpt.Site = this.Site;
            return rpt;
        }
