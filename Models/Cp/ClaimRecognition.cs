...
namespace HACCP.Models.Cp
{
    public class ClaimRecognition
    {
		...
		public string confirm_emp_id0 { get; set; }
		public string confirm_emp_id1 { get; set; }
		public string confirm_emp_id2 { get; set; }
		public string confirm_emp_id3 { get; set; }
		public string claim_status_nm { get; set; }
		public string claim_status { get; set; }

		// 4. default 생성자 
		public ClaimRecognition()
        {

        }

		// 5. DTO 설정
		public ClaimRecognition(DataRow row)
		{
			...
			confirm_emp_id0 = row["confirm_emp_id0"].ToString();
			confirm_emp_id1 = row["confirm_emp_id1"].ToString();
			confirm_emp_id2 = row["confirm_emp_id2"].ToString();
			confirm_emp_id3 = row["confirm_emp_id3"].ToString();
