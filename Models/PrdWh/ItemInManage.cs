...
{
    public class ItemInManage
    {
        public string gubun { get; set; }
        public string packing_result_pack_in_history_id { get; set; }//
        ...
        public string in_type { get; set; }//입고구분
        public string in_qty { get; set; }//기타입고량
        public string in_remark { get; set; }//비고
        ...
        public string past_in_qty { get; set; }//과거 입고 량?
