...
namespace HACCP.Report.Rpt.test {
    ...
    public class imageTest : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "HACCP.Report.Rpt.test.imageTest.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedimageTest : Component, ICachedReport {
