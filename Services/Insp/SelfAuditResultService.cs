...
{
    public class SelfAuditResultService
    {
        ...
        internal DataTable ResultDisplayESInfo(string audit_year, string audit_no, string sign_set_cd)
        {
            string sSpName = "SP_SelfAuditResult";
            string sGubun = "S2";
        ...
        internal string ResultSaveSign(string audit_year, string audit_no, string emp_cd, string type)
        {
            string sSpName = "SP_SelfAuditResult";
            string sGubun = "ES";
            ...
            pParam[0] = "@self_audit_year:" + audit_year;
            pParam[1] = "@self_audit_no:" + audit_no;
            pParam[2] = "@self_audit_rc_emp_cd:" + "";
            pParam[3] = "@self_audit_rc_emp_type:" + "";
            pParam[4] = "@self_audit_r_emp_cd:" + "";
            pParam[5] = "@self_audit_r_emp_type:" + "";
            pParam[6] = "@type:" + type;

            if (type == "rc")
            {
                pParam[2] = "@self_audit_rc_emp_cd:" + emp_cd;
                pParam[3] = "@self_audit_rc_emp_type:" + "2";
            }
            else
            {
                pParam[4] = "@self_audit_r_emp_cd:" + emp_cd;
                pParam[5] = "@self_audit_r_emp_type:" + "2";
            }
        ...
        internal string ResultDeleteSign(string audit_year, string audit_no, string type)
        {
            string sSpName = "SP_SelfAuditResult";
            string sGubun = "ES_D";
        ...
        internal DataTable ResultFileSearch(SelfAudit list)
        {
            string sSpName = "SP_SelfAuditResult";
            string gubun = "DOC_S";
        ...
        internal string ResultFileAdd(byte[] myBytes, string fileName, string contentType, SelfAudit list)
        {
        ...
        internal string ResultFileDelete(string audit_year, string audit_no, string audit_file, string file_id)
        {
            string sSpName = "SP_SelfAuditResult";
            string sGubun = "DOC_D";
        ...
        internal DataTable ResultFileOpen(string file_id)
        {
            string sSpName = "SP_SelfAuditResult";
            string sGubun = "DOC_O";
