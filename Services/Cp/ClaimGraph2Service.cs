...
{
    public class ClaimGraph2Service
    {
        ...
        public DataSet GridSelect2(string start_date, string item_form_cd)
        {
            string sSpName = "SP_ClaimGraph2";
            string sGubun = "S1";
            string[] pParam = new string[2];
            ...
            pParam[0] = "@start_date:" + start_date;
            pParam[1] = "@item_form_cd:" + item_form_cd;
