...
{
    public class TestCheckEService
    {
        private BllSpExecute _bllSpExecute = new BllSpExecute();
        private String sSpName = "SP_TestCheckE";        
        private string sign_set_cd = "1006";

        #region 조회영역
        internal DataTable Select(TestCheckE.SrchParam srchParam)
        {
        ...
        internal DataTable SelectDetail(TestCheckE.SrchParam srchParam, TestCheckE dto)
        {
        ...
        internal DataTable SelectSign(string testcontrol_id, string test_type, string process_kind)
        {
            ...
            pParam[3] = "@program_cd:" + "TestCheckE";
        ...
        #region Trx영역
        // 필요시 주석해지하여 사용
        //internal string TestCheckETRX(TestCheckE dto)
        //{
        //    string[] pParam = null;
        ...
        #region 프로그램별 영역
        internal string CancelCheckInfo(TestCheckE dto)
        {
            string gubun = "U";
            string[] pParam = new string[5];
            ...
            pParam[4] = "@process_cd:" + dto.process_cd;

            string message = _bllSpExecute.SpExecuteString("SP_TestRecognitionE", gubun, pParam);

            string test_result_yn_c = dto.test_result_yn_c;

            if (test_result_yn_c == "C")
            {
                message = "해당 품목이 이미 인계되었습니다. \n<조건부적합> 판정을 취소할 수 없습니다.!";
            }
            else
            {
        ...
        //최종 서명자 여부를 결정한다.
        internal bool GetLastSignEmpCheck(TestCheckE dto)
        {
            bool check = false;
        ...
        //시험 결과 취소
        internal bool CancelSign(TestCheckE dto)
        {
            string gubun = "U";
            string[] pParam = new string[4];
        ...
        internal bool CheckTestStandard(TestCheckE dto)
        {
            bool check = false;
            string gubun = "C";
            string[] pParam = new string[2];
        ...
        internal bool DataCheckYN(TestCheckE dto)
        {
            bool check = false;
            string gubun = "C2"; 
        ...
        //성적일자와 시험일자 비교
        internal bool CheckTestDate(TestCheckE dto)
        {
            bool check = false;
            string gubun = "CK";
            string[] pParam = new string[2];
        ...
        internal bool SignDelegateCheck(string emp_cd, string testcontrol_id, string process_kind, string test_type, string sign_set_dt_id)
        {
            ...
            pParam[5] = "@program_cd:TestCheckE";
            //pParam[6] = "@sign_set_cd: 1006";
        ...
        internal bool SaveElectronicSignature(string gubun, string emp_cd, string testcontrol_id, string process_kind, string test_type, string sign_set_dt_id, string validation_type, string representative_yn)
        {
            ...
            pParam[7] = "@program_cd:TestCheckE";
            //pParam[8] = "@sign_set_cd: 1006";
        ...
        internal bool SaveTestJudgment(TestCheckE dto)
        {
            ...
            param[3] = "@test_informt_remark:" + dto.test_inform_remark;
            param[4] = "@valid_period:" + dto.valid_period;
            param[5] = "@retest_yn:" + dto.retest_yn;

            //2012.05.29 황안례 추가
            param[6] = "@test_result_value:" + dto.test_result_value;
            param[7] = "@qc_valid_period:" + dto.qc_valid_period;   //  de_qc_valid_date.Text; //2012.07.19 황안례 유효기한 컨트롤  EditValue 데이터 변경하도록 수정 (유효기간 오류 수정)

            param[8] = "@extend_yn:" + dto.extend_yn;

            param[9] = "@test_result_value0:" + dto.test_result_value0;
            param[10] = "@test_result_pollination:" + dto.test_result_pollination;
            param[11] = "@test_result_solvent:" + dto.test_result_solvent;

            string message;

            message = _bllSpExecute.SpExecuteString(this.sSpName, "U", param);

            bool flag = false;

            if (Public_Function.IsNumeric(message))
            {
                flag = true;                
            }
            return flag;
        ...
        // 재시험지시
        internal string ReTest(string testcontrol_id, string teststandardmaster_id)
        {            
            string gubun = "RE";
            string[] pParam = new string[2];
        ...
        #endregion
        #region sp param 설정
        private string[] GetParam(TestCheckE.SrchParam srch, TestCheckE dto)
        {
            string[] pParam = null;
        ...
        private string[] TrxGetParam(TestCheckE dto)
        {
