...
{
    public class WorksheetListService
    {
        private BllSpExecute _bllSpExecute = new BllSpExecute();
        private String sSpName = "SP_WorksheetList";        
        //private string sign_set_cd = "1007";

        #region 조회영역
        internal DataTable Select(WorksheetList.SrchParam srchParam)
        {
        ...
        #endregion
        #region sp param 설정
        private string[] GetParam(WorksheetList.SrchParam srch, WorksheetList dto)
        {
            string[] pParam = null;
            ...
            if ("S".Equals(srch.Gubun))
            {
                ...
                pParam[3] = "@test_status:" + srch.re_test_status;
